...
$pro6_gazou_name_old = $post['gazou_name_old'];
...
else
{
      ...
      print '<form method="post" action="pro6_edit_done.php">';
      print '<input type="hidden" name="code" value="'.$pro6_code.'">';
      print '<input type="hidden" name="name" value="'.$pro6_name.'">';
      print '<input type="hidden" name="price" value="'.$pro6_price.'">';
      print '<input type="hidden" name="gazou_name_old" value="'.$pro6_gazou_name_old.'">';
