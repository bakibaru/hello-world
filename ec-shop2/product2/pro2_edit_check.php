...
{
      print '上記のように変更です。<br />';
      print '<form method="post" action="pro2_edit_done.php">';
      print '<input type="hidden" name="code" value="'.$pro2_code.'">';
      print '<input type="hidden" name="name" value="'.$pro2_name.'">';
      print '<input type="hidden" name="price" value="'.$pro2_price.'">';
      print '<input type="hidden" name="gazou_name_old" value="'.$pro2_gazou_name_old.'">';
